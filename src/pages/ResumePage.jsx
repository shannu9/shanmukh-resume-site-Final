...
const sectionCard = (title, content) => (
  <motion.div
    ...
    viewport={{ once: true }}
    className="bg-white/60 backdrop-blur-sm shadow-xl rounded-2xl p-6 w-full mb-6 border border-gray-200"
  >
...
export default function ResumePage() {
  return (
    <div className="bg-gradient-to-br from-[#f3f4f6] to-[#e0f7fa] min-h-screen py-10 px-4 sm:px-8 lg:px-12 xl:px-16 w-full">
